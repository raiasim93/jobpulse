...
export default function Hero (){
    return (
        <>
         <div className="w-full h-fit bg-surface/20 flex flex-col gap-y-12 justify-center items-center rounded mt-4 mb-8 py-16 border border-purple-600/30">
            <div className="text-xl"> Total Applications </div>
            <div className="text-9xl font-extrabold"> 14 </div>
            <div className="flex gap-x-12">
                <button className='h-12 w-12 flex justify-center items-center rounded-lg border'> <Plus/> </button>
                <button className='h-12 w-12 flex justify-center items-center rounded-lg border'> <Minus/> </button>
            </div>
        </div>
         {/* quick add section */}
        <div className='mb-2'> Quick Add </div>
        <div className='w-full h-40 flex items-center gap-y-12  bg-surface rounded px-8 py-4 border border-purple-600/30'>
